 ...
 * @name           5-modern.2c70.js
 * @author         MTS
 * @build          Sat, Feb 9, 2019 3:24 PM ET
 * @release        2141bf79230e2133979c48db47c31629416026ec [master]
 * @copyright      Copyright (c) 2019 MTS
 *
 */
(window.webpackJsonp=window.webpackJsonp||[]).push([[5],{157:function(e,t,r){"use strict";r.d(t,"a",function(){return a});var n=r(66);const a=r.n(n).a`
  query GetPages {
    pages(pageSize: 10) {
      pages {
        id
