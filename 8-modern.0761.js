 ...
 *
 */
(window.webpackJsonp=window.webpackJsonp||[]).push([[8],{158:function(e,t,r){"use strict";r.d(t,"a",function(){return a});var n=r(67);const a=r.n(n).a`
  query GetPages {
    pages(pageSize: 10) {
      pages {
        id
